...
public class Villageois extends Unite {
	...
	private ArrayList<Cellule> watchBois(){ // Methode qui renvoie ce que regarde le villageois (les cellules adjaï¿½ante a la sienne + la sienne) sans les diagonalles)
	...
	private ArrayList<Cellule> watchForum(){ // Methode qui renvoie ce que regarde le villageois (les cellules adjaï¿½ante a la sienne + la sienne) sans les diagonalles)
		ArrayList<Cellule> autour = curent.env.getenv(curent);
	...
	private void IA1 (){
		...
		if (plein){ // Si le villageois est plein , alors il cherche un FORUM pour se vider.
			...
			if (plusproche.objet != null){ // si l'objet n'est pas passer ï¿½ null (destruction de l'agent)
			...
			//////////////////// Le cas oï¿½ tout les villageois n'ont rien trouvï¿½ , il cherche dans son environnement du bois ////////////////////////////////////////////////////////////// 
				...
				if (autour2.isEmpty()){
					...
					this.curent = autour2.get(0); // pour le moment : le villageois va ï¿½ la premiï¿½re ressource dï¿½finis dans le tableau
